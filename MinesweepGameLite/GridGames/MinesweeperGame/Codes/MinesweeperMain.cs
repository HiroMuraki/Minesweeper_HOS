...
namespace MinesweepGameLite {
    public class MinesweeperMain : IGridGame, INotifyPropertyChanged {
        ...
        public string ProcessStatus {
            get {
                return $"{this.Game.FlagsCount} | {this.Game.MineSize}";
            }
        }
        ...
        public MinesweeperMain(MainGameWindow gameWindow) {
            this.Game = new MinesweeperGame(BlockCreateAction);
